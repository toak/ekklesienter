...
import { LayoutTemplate, RefreshCw, Download } from 'lucide-react';
import { cn } from '@/core/utils/cn';
import { ITemplate, IBlock, ISlide, ITemplateSlide, ICanvasItem, ICanvasSlide } from '@/core/types';
import SlideContentRenderer from '@/features/presenter/components/slide-editor/SlideContentRenderer';

interface ITemplatePreviewItemProps {
    template: ITemplate;
