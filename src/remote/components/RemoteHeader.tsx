        ...
        <div className="flex justify-between items-center mb-6 shrink-0">
            <div className="flex items-center gap-3">
                <span
                    ...
                    className={cn(
                        "font-black text-[10px] uppercase tracking-[0.3em] px-4 py-2 rounded-2xl border transition-all duration-500 cursor-pointer active:scale-95 select-none",
                        isActive
            ...
            <button
                onClick={onLogout}
                className="p-3 bg-stone-900/60 rounded-2xl border border-white/5 active:bg-stone-800 transition-all text-stone-500 hover:text-accent"
            >
                <LogOut size={18} />
            </button>
        </div>
