---
name: ui-ux-pro-max
description: Design intelligence for building professional UI/UX across multiple platforms and frameworks. Use this skill when you need to build, design, or improve web interfaces, specialized components, or entire design systems. Supports Tailwind, React, Vue, and more.
---
...
### Using Antigravity Marketplace (Antigravity Code)

Install directly in Antigravity Code with two commands:
...
uipro init --ai claude      # Antigravity Code
